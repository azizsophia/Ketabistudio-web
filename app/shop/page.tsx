...
const TILES: Tile[] = [
  ...
  },
  {
    ...
    title: "From One Root",
    sub: "One Arabic root a day, rahma, sabr, shukr, traced to the ayah it lives in, with room to write. As an instant PDF or a coil-bound printed copy.",
    cta: "Start day one \u2192",
    price: "PDF $19.00 · printed $34.99",
