...
export const metadata: Metadata = {
  ...
  description:
    "Fill a beautiful hardcover keepsake with your own photos and words — twenty things you love about Grandpa, sealed with a dua for those who raised us. Printed to order.",
};
